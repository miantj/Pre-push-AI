...
import { CONFIG_REL_PATH } from "./paths";
import {
  AgentType,
  AiCodeReviewConfig,
  HookType,
...
/** 本次 hook/CLI 调用跳过审查（不跑 Agent/Provider） */
export function isReviewSkipped(): boolean {
  return isTruthySkipFlag(process.env.SKIP_REVIEW);
}
