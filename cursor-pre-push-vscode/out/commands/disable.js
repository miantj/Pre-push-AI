...
function registerDisableCommand(context, settingsProvider, hookInstaller) {
    context.subscriptions.push(vscode.commands.registerCommand("cursor.prePush.disable", async () => {
