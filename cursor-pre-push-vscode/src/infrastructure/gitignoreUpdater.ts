...
import { WORKSPACE_PROMPT_REL } from "./reviewPromptFile";
import {
  API_KEY_ENV_REL,
...
export const REVIEW_REPORT_REL = ".cursor/ai-code-review-last.md";
export const PASS_CACHE_REL = ".cursor/ai-code-review-pass-cache";
export const HOOK_RUNNER_REL = ".cursor/ai-code-review-hook.sh";
