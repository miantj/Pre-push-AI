...
export const WORKSPACE_CONFIG_REL = ".cursor/ai-code-review.json";
export const WORKSPACE_CONFIG_GUIDE_REL = ".cursor/ai-code-review.说明.md";
export const API_KEY_ENV_REL = ".cursor/ai-code-review.env";
...
export class SettingsProvider {
  ...
  /**
   * 工作区配置唯一来源：`.cursor/ai-code-review.json`（存在时）。
  ...
  writeWorkspaceConfigFile(config: AiCodeReviewConfig): boolean {
    ...
    try {
      ...
      fs.writeFileSync(guidePath, describeConfig(config, promptText), "utf8");
